...
import com.atguigu.spark.common.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
...
/**
  * 模拟数据生成类
  *   运行之后会报错：因为当前开发环境用户是lenovo，但是hadoop文件的所有者是atguigu，
  *   需要配置参数   -DHADOOP_USER_NAME=atguigu
  *
  */
